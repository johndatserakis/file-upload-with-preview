...
var FileUploadWithPreview = /*#__PURE__*/function () {
  function FileUploadWithPreview(uploadId) {
    ...
    this.uploadId = uploadId; // Base options
    ...
    if (this.options.presetFiles) {
      ...
      this.addImagesFromPath(this.options.presetFiles)["catch"](function (error) {
        console.warn("".concat(error.toString()));
        console.warn('An image you added from a path cannot be added to the cachedFileArray.');
      });
    } // Text options


    var browse = text.browse,
        chooseFile = text.chooseFile,
        selectedCount = text.selectedCount;
    this.options.text.chooseFile = chooseFile !== null && chooseFile !== void 0 ? chooseFile : DEFAULT_CHOOSE_FILE_TEXT;
    this.options.text.browse = browse !== null && browse !== void 0 ? browse : DEFAULT_BROWSE_TEXT;
    this.options.text.selectedCount = selectedCount !== null && selectedCount !== void 0 ? selectedCount : DEFAULT_FILES_SELECTED_TEXT; // Elements
    ...
    var inputLabel = this.el.querySelector('.custom-file-container__custom-file__custom-file-control');
    var imagePreview = this.el.querySelector('.custom-file-container__image-preview');
    var clearButton = this.el.querySelector('.custom-file-container__image-clear');
    ...
    this.addBrowseButton(this.options.text.browse); // Images

    var backgroundImage = images.backgroundImage,
        baseImage = images.baseImage,
        successFileAltImage = images.successFileAltImage,
        successPdfImage = images.successPdfImage,
        successVideoImage = images.successVideoImage;
    this.options.images.baseImage = baseImage !== null && baseImage !== void 0 ? baseImage : DEFAULT_BASE_IMAGE;
    this.options.images.successPdfImage = successPdfImage !== null && successPdfImage !== void 0 ? successPdfImage : DEFAULT_SUCCESS_PDF_IMAGE;
    this.options.images.successVideoImage = successVideoImage !== null && successVideoImage !== void 0 ? successVideoImage : DEFAULT_SUCCESS_VIDEO_IMAGE;
    this.options.images.successFileAltImage = successFileAltImage !== null && successFileAltImage !== void 0 ? successFileAltImage : DEFAULT_SUCCESS_FILE_ALT_IMAGE;
    this.options.images.backgroundImage = backgroundImage !== null && backgroundImage !== void 0 ? backgroundImage : DEFAULT_BACKGROUND_IMAGE;
  ...
  _createClass(FileUploadWithPreview, [{
    ...
    value: function bindClickEvents() {
      ...
      this.imagePreview.addEventListener('click', function (e) {
        ...
        if (target.matches('.custom-file-container__image-multi-preview__single-image-clear__icon')) {
          var fileToken = target.getAttribute('data-upload-token');
    ...
    value: function addFiles(files) {
      ...
      if (this.options.maxFileCount > 0 && files.length + this.cachedFileArray.length > this.options.maxFileCount) {
      ...
      Array.from(files).forEach(function (file) {
        ...
        _this2.cachedFileArray.push(file);

        _this2.renderFile(file);
      });
    ...
    value: function renderFile(file) {
      ...
      reader.onload = function () {
        ...
        // //////////////////////////////////////////////////
        if (!_this3.input.multiple) {
          if ( // If png, jpg/jpeg, gif, use the actual image
          file.type.match('image/png') || file.type.match('image/jpeg') || file.type.match('image/gif')) {
            _this3.imagePreview.style.backgroundImage = "url(\"".concat(reader.result, "\")");
          } else if (file.type.match('application/pdf')) {
            // PDF Upload
            _this3.imagePreview.style.backgroundImage = "url(\"".concat(_this3.options.images.successPdfImage, "\")");
          } else if (file.type.match('video/*')) {
            // Video upload
            _this3.imagePreview.style.backgroundImage = "url(\"".concat(_this3.options.images.successVideoImage, "\")");
          } else {
            // Everything else
            _this3.imagePreview.style.backgroundImage = "url(\"".concat(_this3.options.images.successFileAltImage, "\")");
          }
        ...
        if (_this3.input.multiple) {
          ...
          _this3.imagePreview.style.backgroundImage = "url(\"".concat(_this3.options.images.backgroundImage, "\")"); // If png, jpg/jpeg, gif, use the actual image

          if (file.type.match('image/png') || file.type.match('image/jpeg') || file.type.match('image/gif')) {
            if (_this3.options.showDeleteButtonOnImages) {
              _this3.imagePreview.innerHTML += "\n              <div\n                class=\"custom-file-container__image-multi-preview\"\n                data-upload-token=\"".concat(file.token, "\"\n                style=\"background-image: url('").concat(reader.result, "'); \"\n              >\n                <span class=\"custom-file-container__image-multi-preview__single-image-clear\">\n                  <span\n                    class=\"custom-file-container__image-multi-preview__single-image-clear__icon\"\n                    data-upload-token=\"").concat(file.token, "\"\n                  >\n                    &times;\n                  </span>\n                </span>\n              </div>\n            ");
            } else {
              _this3.imagePreview.innerHTML += "\n              <div\n                class=\"custom-file-container__image-multi-preview\"\n                data-upload-token=\"".concat(file.token, "\"\n                style=\"background-image: url('").concat(reader.result, "'); \"\n              />\n            ");
            }
          } else if (file.type.match('application/pdf')) {
            // PDF Upload
            if (_this3.options.showDeleteButtonOnImages) {
              _this3.imagePreview.innerHTML += "\n              <div\n                class=\"custom-file-container__image-multi-preview\"\n                data-upload-token=\"".concat(file.token, "\"\n                style=\"background-image: url('").concat(_this3.options.images.successPdfImage, "'); \"\n              >\n                <span class=\"custom-file-container__image-multi-preview__single-image-clear\">\n                  <span\n                    class=\"custom-file-container__image-multi-preview__single-image-clear__icon\"\n                    data-upload-token=\"").concat(file.token, "\"\n                  >&times;</span>\n                </span>\n              </div>\n            ");
            } else {
              _this3.imagePreview.innerHTML += "\n              <div\n                class=\"custom-file-container__image-multi-preview\"\n                data-upload-token=\"".concat(file.token, "\"\n                style=\"background-image: url('").concat(_this3.options.images.successPdfImage, "'); \"\n              />\n            ");
            }
          } else if (file.type.match('video/*')) {
            // Video upload
            if (_this3.options.showDeleteButtonOnImages) {
              _this3.imagePreview.innerHTML += "\n              <div\n                class=\"custom-file-container__image-multi-preview\"\n                style=\"background-image: url('".concat(_this3.options.images.successVideoImage, "'); \"\n                data-upload-token=\"").concat(file.token, "\"\n              >\n                <span class=\"custom-file-container__image-multi-preview__single-image-clear\">\n                  <span\n                    class=\"custom-file-container__image-multi-preview__single-image-clear__icon\"\n                    data-upload-token=\"").concat(file.token, "\"\n                  >&times;</span>\n                </span>\n              </div>\n            ");
            } else {
              _this3.imagePreview.innerHTML += "\n              <div\n                class=\"custom-file-container__image-multi-preview\"\n                style=\"background-image: url('".concat(_this3.options.images.successVideoImage, "'); \"\n                data-upload-token=\"").concat(file.token, "\"\n              />\n            ");
            }
          } else {
            ...
            if (_this3.options.showDeleteButtonOnImages) {
              _this3.imagePreview.innerHTML += "\n              <div\n                class=\"custom-file-container__image-multi-preview\"\n                style=\"background-image: url('".concat(_this3.options.images.successFileAltImage, "'); \"\n                data-upload-token=\"").concat(file.token, "\"\n              >\n                <span class=\"custom-file-container__image-multi-preview__single-image-clear\">\n                  <span\n                    class=\"custom-file-container__image-multi-preview__single-image-clear__icon\"\n                    data-upload-token=\"").concat(file.token, "\"\n                  >&times;</span>\n                </span>\n              </div>\n            ");
            } else {
              _this3.imagePreview.innerHTML += "\n              <div\n                class=\"custom-file-container__image-multi-preview\"\n                style=\"background-image: url('".concat(_this3.options.images.successFileAltImage, "'); \"\n                data-upload-token=\"").concat(file.token, "\"\n              />\n            ");
            }
          }
    ...
    value: function addImagesFromPath(files) {
      ...
      return new Promise( /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(resolve, reject) {
          var presetFiles;
